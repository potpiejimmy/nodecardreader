module.exports.padNumber = function(num, digits) {
...
module.exports.ebcdicHexToAscii = function(hexstring) {
    return ebcdicToAscii(Buffer.from(hexstring, 'hex'));
}

module.exports.ebcdicToAscii = function(buf) {
    for (let i=0; i<buf.length; i++) buf[i] = e2a[buf[i]];
    return buf.toString();
}

module.exports.asciiToEbcdic = function(input) {
    let result = [];
